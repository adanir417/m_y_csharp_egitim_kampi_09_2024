...
## Notlar
Programlamada yazım stilleri - Programming Case Styles - [Programming Case Styles](https://www.ituonline.com/blogs/programming-case-styles/)  
CSharp String içerisinde sayısal değerleri düzenleme - CSharp Standart Numberic Format Strings - [CSharp Standart Numberic Format Strings](https://learn.microsoft.com/en-us/dotnet/standard/base-types/standard-numeric-format-strings)  
Visual Studio 2022 Shortcuts(Tuş Kısayolları) - [VS2022 Shortcuts & commands](https://learn.microsoft.com/en-us/visualstudio/ide/default-keyboard-shortcuts-in-visual-studio?view=vs-2022)    
List of MSSQL data types equivalent to CSharp data types(MSSQL içindeki veri tipinin CSharp veri tipi karşılıkları) - [C# .NET and SQL Server supported data types](https://learn.microsoft.com/en-us/sql/language-extensions/how-to/c-sharp-to-sql-data-types?view=sql-server-ver16)       
2 - List of MSSQL data types equivalent to CSharp data types(2 - MSSQL içindeki veri tipinin CSharp veri tipi karşılıkları) - [SQL Server Data Type Mappings](https://learn.microsoft.com/en-us/dotnet/framework/data/adonet/sql-server-data-type-mappings)       
